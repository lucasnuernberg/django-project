...
print(learner_david.user_ptr.dob)
...
courses = Course.objects.filter(instructors=Instructor.objects.get(first_name="Yan").id)
occupation_list = set()
...
print('--------------------------')
print(Enrollment.objects.all()[0].learner)
